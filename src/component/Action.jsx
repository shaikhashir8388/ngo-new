...
const Action = () => {
  return (
    ...
    lg:items-start min-h-screen relative 
    text-black'>
      {/* Left Side Image */}
      <div className='w-[90%] sm:w-[80%] md:w-[60%] lg:w-[40%] mt-10 lg:mt-0'>
      ...
      <div className='w-[90%] sm:w-[80%] md:w-[60%] lg:w-[40%] p-6'>
        <div className='lg:sticky top-6'>
          <h1 className='text-[28px] sm:text-[32px] md:text-[36px] lg:text-[42px] font-bold text-white text-center lg:text-left'>Make a Difference Today</h1>
          <p className='text-sm sm:text-base md:text-lg text-justify mt-5'>
