...
import backgroundImage from '/Web-Icon.png';
import AOS from 'aos';
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="flex flex-col">
              <img src="/hall.jpg" alt="First" className="w-full h-64 object-cover" />
              <img src="/hall2.jpg" alt="Second" className="w-full h-64 object-cover" />
            </div>
